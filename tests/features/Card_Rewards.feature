Feature: Card Rewards 
  ...
  Scenario: Card Rewards  for AI
    Given I open Whats Web
  
    When I send message 0 from module "cardrewards"
    Then Bot should respond with "menu"
    When I send message 1 from module "cardrewards"
    Then Bot should respond with "Transactions"
    When I send message 2 from module "cardrewards"
    Then Bot should respond with "Transactions"
    When I send message 3 from module "cardrewards"
    Then Bot should respond with "Transactions"
